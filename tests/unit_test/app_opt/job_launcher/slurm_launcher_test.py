...
def test_launcher_rejects_invalid_submit_timeout(tmp_path, value):
    with pytest.raises(SlurmLauncherError, match="submit_timeout"):
        _launcher(tmp_path, _workspace(tmp_path), submit_timeout=value)
